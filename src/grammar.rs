        ...
        let start_pos = pos;
        {
            ...
            match seq_res {
                Matched(pos, char_) => {
                    {
                        let match_str = input.slice(start_pos, pos);
                        Matched(pos, CharSetCase{start: char_, end: char_,})
                    }
                }
                Failed => Failed,
            }
...
fn parse_hexEscapeSequence(input: &str, state: &mut ParseState, pos: uint) ->
 ParseResult<char> {
    {
        let start_pos = pos;
        {
...
fn parse_unicodeEscapeSequence(input: &str, state: &mut ParseState, pos: uint)
 -> ParseResult<char> {
    {
        let start_pos = pos;
        {
